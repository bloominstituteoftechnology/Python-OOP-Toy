...
def debug_create_balls(object_list):
    # ball = Ball(SCREEN_SIZE, Vector2(50, 500), Vector2(4, 3), [255, 0, 0], 10)
    ...
    #                        [0, 255, 0], 15)
    # object_list.append(ball)
    ball = Ball(SCREEN_SIZE, Vector2(400, 200), Vector2(0, 0),
                [0, 0, 255], 15)
    object_list.append(ball)
    ball = KineticBall(SCREEN_SIZE, Vector2(200, 200), Vector2(10, 0),
