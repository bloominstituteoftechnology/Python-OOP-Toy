...
from ball import Ball, RainbowBall, BouncingBall, BouncingRainbow, \
    KineticBall, KineticBouncing, FrictionBall, Planet
...
def debug_create_balls(object_list):
    ball = Planet(SCREEN_SIZE, Vector2(90, 100), Vector2(5, 0),
                  [255, 0, 0], 10, object_list)
    ...
    # object_list.append(ball)
    ball = Planet(SCREEN_SIZE, Vector2(320, 240), Vector2(0, 0),
                  [60, 60, 60], 40, object_list)
    object_list.append(ball)
